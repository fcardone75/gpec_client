...
/**
 * This class stands for GetMailByIdRequest StructType
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: s1:GetMailByIdRequest
 * @subpackage Structs
 */
...
class GetMailByIdRequest extends GetMailRequest
{
    ...
    protected ?string $id;
    /**
     * Constructor method for GetMailByIdRequest
     * @uses GetMailByIdRequest::setTypeOfElement()
     * @uses GetMailByIdRequest::setId()
